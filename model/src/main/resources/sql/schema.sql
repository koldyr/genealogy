...
alter table T_CHILDREN
    add constraint PK_CHILDREN PRIMARY KEY (CHILD_ID, FAMILY_ID);
alter table T_CHILDREN
    add constraint FK_CHILD_FAMILY FOREIGN KEY (FAMILY_ID) REFERENCES T_FAMILY (FAMILY_ID);
alter table T_CHILDREN
    add constraint FK_CHILD_PERSON FOREIGN KEY (CHILD_ID) REFERENCES T_PERSON (PERSON_ID);
