...
insert into T_PERSON (PERSON_ID, PLACE, OCCUPATION, NOTE, GENDER, FIRST_NAME, MIDDLE_NAME, LAST_NAME, MAIDEN_NAME, USER_ID, LINEAGE_ID)
values (NEXTVAL('SEQ_PERSON'), 'p1_place', 'p1_occup', 'p1_note', 'M', 'p1_first', 'p1_middle', 'p1_last', null, CURRVAL('SEQ_USER'), CURRVAL('SEQ_LINEAGE'));
...
insert into T_PERSON (PERSON_ID, PLACE, OCCUPATION, NOTE, GENDER, FIRST_NAME, MIDDLE_NAME, LAST_NAME, MAIDEN_NAME, USER_ID, LINEAGE_ID)
values (NEXTVAL('SEQ_PERSON'), 'p2_place', 'p2_occup', 'p2_note', 'F', 'p2_first', 'p2_middle', 'p2_last', 'p2_maiden', CURRVAL('SEQ_USER'), CURRVAL('SEQ_LINEAGE'));
insert into T_PERSON_EVENT (EVENT_ID, TYPE, PLACE, NOTE, EVENT_DATE, PERSON_ID)
...
insert into T_PERSON (PERSON_ID, PLACE, OCCUPATION, NOTE, GENDER, FIRST_NAME, MIDDLE_NAME, LAST_NAME, MAIDEN_NAME, USER_ID, LINEAGE_ID)
values (NEXTVAL('SEQ_PERSON'), 'p3_place', 'p3_occup', 'p3_note', 'M', 'p3_first', 'p3_middle', 'p3_last', null, CURRVAL('SEQ_USER'), CURRVAL('SEQ_LINEAGE'));
insert into T_PERSON_EVENT (EVENT_ID, TYPE, PLACE, NOTE, EVENT_DATE, PERSON_ID)
...
insert into T_PERSON (PERSON_ID, PLACE, OCCUPATION, NOTE, GENDER, FIRST_NAME, MIDDLE_NAME, LAST_NAME, MAIDEN_NAME, USER_ID, LINEAGE_ID)
values (NEXTVAL('SEQ_PERSON'), 'p4_place', 'p4_occup', 'p4_note', 'F', 'p4_first', 'p4_middle', 'p4_last', null, CURRVAL('SEQ_USER'), CURRVAL('SEQ_LINEAGE'));
insert into T_PERSON_EVENT (EVENT_ID, TYPE, PLACE, NOTE, EVENT_DATE, PERSON_ID)
...
insert into T_FAMILY (FAMILY_ID, HUSBAND_ID, WIFE_ID, NOTE, USER_ID, LINEAGE_ID)
values (NEXTVAL('SEQ_FAMILY'), 1, 2, 'f1_note', CURRVAL('SEQ_USER'), CURRVAL('SEQ_LINEAGE'));
